$(document).ready(function () {
  ...
  var intro =
    "<p>Hi, I am Tom, a visual designer living in Seoul, South Korea, and have focused on experimenting mixture of graphic, animation, and programming, so my majority of graphic design work is screen-based media. I make 2D/3D motion, and branding.<br/><br/>-</p>";
  var contact =
  ...
  var info1 =
    '<p><h2 class="empha">Training</h2> BFA Graphic Design with high distinction - California College of the Arts, Spring 2019</p>';
  var info2 =
    '<p><h2 class="empha">Awards</h2> Student To Watch - Graphic Design USA, Spring 2019<br/><br/>-</p>';
